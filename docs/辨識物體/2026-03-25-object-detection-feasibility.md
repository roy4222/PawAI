...
| 設計文件 | `docs/辨識物體/README.md` v1.1（2026-03-11），含完整介面定義與 D435 整合設計 |
...
> 本節設計已在 `docs/辨識物體/README.md` v1.1 詳細定義，此處摘要關鍵技術決策。
...
#### 事件 JSON Schema（對齊 `docs/辨識物體/README.md` v1.1）
...
**結論**：YOLOE 適合作為雲端 B 線（`docs/辨識物體/README.md` §3.1 的 B 線候選），不適合本地部署。未來可作為「使用者問什麼就偵測什麼」的進階能力。
