...
- 寫 `docs/navigation/2026-06-13-initialpose-yaw-calibration-sop.md`：①使用者站機鼻 0.5m → `lidar_front_sector.py` 確認 ±180° bin ②`tf2_echo` 確認外參 ③設 initialpose 後等 covariance(含 c[35]) 收斂 ④goto 前 sanity。
