...
**前置文件**：
- [`docs/navigation/README.MD`](../navigation/README.MD) — 導航避障總體規劃
- [`docs/navigation/深度攝影機避障.md`](../navigation/深度攝影機避障.md) — Phase 0-2 設計文件
- [`docs/navigation/Go2_低頻感測與BurstGap_研究綜整_2026-03-03.md`](../navigation/Go2_低頻感測與BurstGap_研究綜整_2026-03-03.md) — LiDAR Go/No-Go 分析
...
[`docs/navigation/深度攝影機避障.md`](../navigation/深度攝影機避障.md) 於 2026-03-11 建立，規劃了 Phase 0（反應式避障）→ Phase 1（Nav2 局部導航）→ Phase 2（nvblox + 語意）三階段路線。該文件設計完整但因以下原因未落地：
...
根據 [`Go2_低頻感測與BurstGap_研究綜整_2026-03-03.md`](../navigation/Go2_低頻感測與BurstGap_研究綜整_2026-03-03.md) 的分析：
...
遵循專案 [Clean Architecture 分層原則](../archive/2026-05-docs-reorg/architecture-misc/clean_architecture.md)，將避障模組分為四層：
...
完整採納決策文件見 [`docs/navigation/開源專案/`](../navigation/開源專案/) 目錄。
