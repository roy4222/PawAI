...
> **What this README is NOT**：不是能力真相源、不是量測協定、不是 demo 劇本、不是 ADR。能力「能不能講」回 [`../mission/2026-06-18-capability-claim-matrix.md`](../mission/2026-06-18-capability-claim-matrix.md)；「怎麼量」回 [`../pawai-brain/specs/2026-06-18-capability-baseline-spec.md`](../pawai-brain/specs/2026-06-18-capability-baseline-spec.md)。
...
> 2. **收斂審計（read-only）**：[`../pawai-brain/research/2026-06-05-618-demo-convergence-audit-and-model-tournament.md`](../pawai-brain/research/2026-06-05-618-demo-convergence-audit-and-model-tournament.md)
> 3. **能力規格（怎麼量）**：[`../pawai-brain/specs/2026-06-18-capability-baseline-spec.md`](../pawai-brain/specs/2026-06-18-capability-baseline-spec.md)
