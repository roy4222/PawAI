...
> **配套文件**：
> - `docs/archive/pawai-brain-legacy/plans/2026-05-10-demo-readiness-master-plan.md` §5 砍/留紅線
> - `docs/archive/pawai-brain-legacy/plans/2026-05-12-runtime-fallback-readiness.md` 三模式啟動
> - `docs/archive/pawai-brain-legacy/dev-logs/2026-05-12-llm-naturalness-ab-eval.md` LLM 主線決策
