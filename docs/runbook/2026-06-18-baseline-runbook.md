...
> **關係**：Master Plan `docs/archive/pawai-brain-legacy/plans/2026-05-31-capability-baseline-scoreboard-plan.md`｜Spec `docs/architecture/specs/2026-06-18-capability-baseline-spec.md`｜Implementation `docs/archive/pawai-brain-legacy/plans/2026-06-01-scoreboard-implementation-plan.md`
