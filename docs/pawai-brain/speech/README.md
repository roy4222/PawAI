...
詳見：`docs/pawai-brain/specs/2026-05-05-tts-rewrite-result.md`（Stage 4 chain 機制）+ commit `10829ca`（per-message plumbing）+ commit `a2eefc8`（5/8 統一 routing）。
