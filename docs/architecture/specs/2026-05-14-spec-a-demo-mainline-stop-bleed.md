...
| F3 | `docs/architecture/README.md:18` 寫主模型是 `Gemini 3 Flash`，但 code 主線為 `openai/gpt-5.4-mini` | demo 操作誤判、debug 方向錯 | Medium |
...
| `docs/architecture/README.md` L18 | 主模型改 `openai/gpt-5.4-mini`，fallback 列 `google/gemini-3-flash-preview`，註明「以 `conversation_graph_node.py` / launch params 為準」 |
...
| README 主模型 | `docs/architecture/README.md` | 2 |
...
| 設定 / 文件 | `scripts/start_full_demo_tmux.sh`、`docs/architecture/README.md`、`docs/runbook/README.md`、`docs/pawai_cli/team-onboarding.md`、`.gitignore`（PR 2B） | 1, 2A, 2B |
