...
| `docs/architecture/specs/2026-04-27-pawai-brain-skill-first-design.md` | Brain MVS 技術 spec（Phase A） |
| `docs/archive/pawai-brain-legacy/plans/2026-04-27-pawai-brain-skill-first.md` | Brain MVS 實作 plan（Phase A） |
| `docs/architecture/brain/overview.md` | Brain × Studio 整合總覽（已對外可讀） |
