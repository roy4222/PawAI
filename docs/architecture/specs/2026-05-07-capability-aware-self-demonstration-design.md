...
> **Predecessor**: `docs/architecture/specs/2026-05-06-conversation-engine-langgraph-design.md`
>                 `docs/architecture/brain/overview.md` §3.5
> **Successor**: 待寫 `docs/architecture/specs/2026-05-XX-pawclaw-workspace-files-design.md`（Phase 2 OpenClaw 樣式 workspace markdown）
...
docs/architecture/brain/overview.md
