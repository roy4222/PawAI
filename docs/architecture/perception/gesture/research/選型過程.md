...
> **⚠️ research-only / 歷史（非真相）**：本檔是 3/27 整理的選型歷史，**不是能力真相**。⚠️ **gesture.wave 6/04 trusted = 🔴 fail**；grade 以 [`baseline-evidence/2026-06-04-hitl/`](../../../../runbook/baseline-evidence/2026-06-04-hitl/)、claim 邊界以 [claim matrix `gesture.wave`](../../../../mission/2026-06-18-capability-claim-matrix.md#gesturewave) 為準。

> 從原 `docs/architecture/perception/gesture/README.md` 提取（2026-03-27 整理）。
...
> 參考：`docs/archive/2026-05-docs-reorg/research-misc/2026-03-25-go2-sdk-capability-and-architecture.md` S5.4 Phase 4a
