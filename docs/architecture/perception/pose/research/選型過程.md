...
> **⚠️ research-only / 歷史（非真相）**：本檔是 3/27 整理的選型歷史，**不是能力真相**。⚠️ **pose.basic 6/04 = Studio-only / insufficient；跌倒 = future、非緊急**。grade 以 [`baseline-evidence/2026-06-04-hitl/`](../../../../runbook/baseline-evidence/2026-06-04-hitl/)、claim 邊界以 [claim matrix `pose.basic / pose.fall`](../../../../mission/2026-06-18-capability-claim-matrix.md#posebasic--posefall) 為準。

> 從原 `docs/architecture/perception/pose/README.md` 提取（2026-03-27 整理）。
