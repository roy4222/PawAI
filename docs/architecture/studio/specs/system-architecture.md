...
>
> **與現行 gateway README 衝突點**（本檔 vs `pawai-studio/README.md` + `docs/architecture/studio/README.md`）：部署目標（RTX 8000 vs Jetson）、事件總線（Redis vs rclpy 直連）、port（8000/8001 vs 8080）。**衝突一律以 current（studio/README.md + gateway 程式碼）為準。**
