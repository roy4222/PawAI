...
| 檔案 / 路徑 | 內容 |
|---|---|
| **入口頁(本檔)** | `docs/architecture/README.md` |
| **架構索引** | `docs/architecture/brain/README.md` |
| **架構總覽**(Brain × Studio 整合) | `docs/architecture/brain/overview.md` |
...
- `docs/architecture/speech/` `docs/architecture/perception/face/` `docs/architecture/perception/gesture/` `docs/architecture/perception/pose/` `docs/architecture/perception/object/` — 各感知模組權威文件(各帶 `CLAUDE.md` 工作規則)
- `docs/architecture/studio/` — Studio 既有設計
