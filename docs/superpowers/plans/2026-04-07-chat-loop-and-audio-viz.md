...
**Spec:** `docs/superpowers/specs/2026-04-07-chat-loop-and-audio-viz-design.md`
...
```bash
git add \
  docs/superpowers/specs/2026-04-07-chat-loop-and-audio-viz-design.md \
  docs/superpowers/plans/2026-04-07-chat-loop-and-audio-viz.md
