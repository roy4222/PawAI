...
**Spec:** [`docs/superpowers/specs/2026-04-24-p0-nav-obstacle-avoidance-design.md`](../specs/2026-04-24-p0-nav-obstacle-avoidance-design.md)
...
- Modify: `docs/導航避障/README.md`

- [ ] **Step 1: 更新 `docs/導航避障/README.md` 狀態卡**
...
```bash
git add docs/mission/README.md docs/導航避障/README.md
