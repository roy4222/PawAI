...
- `docs/architecture/contracts/interaction_contract.md` v2.6：新增 BodyState / nav skill schema
...
| `docs/superpowers/specs/2026-04-27-pawai-brain-skill-first-design.md` | Brain MVS 技術 spec（Phase A） |
| `docs/superpowers/plans/2026-04-27-pawai-brain-skill-first.md` | Brain MVS 實作 plan（Phase A） |
| `docs/architecture/pawai-brain-studio-overview.md` | Brain × Studio 整合總覽（已對外可讀） |
| `docs/superpowers/specs/2026-04-11-pawai-home-interaction-design.md` | PawAI 系統定位（產品 / 願景 / 4/11 三層） |
| `docs/mission/README.md` | 專案方向、時程、分工 |

未來可能新增（Phase B 正式啟動時）：
- `docs/superpowers/plans/2026-XX-XX-pawclaw-embodied-brain-v1.md` — Phase B 實作 plan
