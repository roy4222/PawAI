...
**前置文件**：
- [`docs/導航避障/README.MD`](../導航避障/README.MD) — 導航避障總體規劃
- [`docs/導航避障/深度攝影機避障.md`](../導航避障/深度攝影機避障.md) — Phase 0-2 設計文件
- [`docs/導航避障/Go2_低頻感測與BurstGap_研究綜整_2026-03-03.md`](../導航避障/Go2_低頻感測與BurstGap_研究綜整_2026-03-03.md) — LiDAR Go/No-Go 分析
...
[`docs/導航避障/深度攝影機避障.md`](../導航避障/深度攝影機避障.md) 於 2026-03-11 建立，規劃了 Phase 0（反應式避障）→ Phase 1（Nav2 局部導航）→ Phase 2（nvblox + 語意）三階段路線。該文件設計完整但因以下原因未落地：
...
| 碰撞監控配置 | `docs/導航避障/深度攝影機避障.md` 中的 collision_monitor_params |
...
完整採納決策文件見 [`docs/導航避障/開源專案/`](../導航避障/開源專案/) 目錄。
...
| 文件 | 路徑 |
|------|------|
| 導航避障總體規劃 | `docs/導航避障/README.MD` |
| 深度攝影機避障設計 | `docs/導航避障/深度攝影機避障.md` |
| LiDAR 低頻感測研究 | `docs/導航避障/Go2_低頻感測與BurstGap_研究綜整_2026-03-03.md` |
| 落地計畫 v2 | `docs/導航避障/落地計畫_v2.md` |
| 開源專案採納決策 | `docs/導航避障/開源專案/*.md` |
| Clean Architecture 原則 | `docs/architecture/designs/clean_architecture.md` |
