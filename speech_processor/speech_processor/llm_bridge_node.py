...
class LlmBridgeNode(Node):
    ...
    def _declare_parameters(self) -> None:
        ...
        # takes over with phase-aware canned (never a 15s dead-air timeout).
        # No _env_float helper on this node; launch arg / `ros2 param set
        # llm_timeout 15.0` restores the old value. Rollback: restore 15.0.
        # Does NOT touch openrouter_request_timeout_s(4) / overall_budget(5).
        self.declare_parameter("llm_timeout", 6.0)
