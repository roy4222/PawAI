...
**當前日期：2026-03-20（Benchmark 框架 Batch 0+1 完成，3/19 會議後更新）**
...
- `vision_perception` — 手勢+姿勢模組（vision_perception_node / mock_event_publisher / event_action_bridge / interaction_router / vision_status_display）
