...
- **Studio 設計規格**：`docs/architecture/studio/README.md`
- **系統架構**：`docs/architecture/studio/specs/system-architecture.md`
- **事件 Schema**：`docs/architecture/studio/specs/event-schema.md`
- **UI 編排**：`docs/architecture/studio/specs/ui-orchestration.md`
- **Brain Adapter**：`docs/architecture/studio/specs/brain-adapter.md`
