...
MOTION_NAME_MAP: dict[str, int] = {
    ...
    "sit": 1009,
    "stand": 1004,
    "stand_down": 1005,  # H: lower posture (closest Go2 has to "lay-flat")
    "content": 1020,
    "balance_stand": 1002,
    "stretch": 1017,
...
SKILL_REGISTRY: dict[str, SkillContract] = {
    ...
    "sit_along": SkillContract(
        ...
        priority_class=PriorityClass.SKILL,
        cooldown_s=15.0,
        description="Lower posture (StandDown 1005) when user sits — Go2 has no true lay-flat motion.",
        bucket="active",
        display_name="趴低陪你",
        demo_status_baseline="available_execute",
        demo_value="medium",
        demo_reason="低風險陪伴動作（Go2 StandDown）",
    ),
    "stand": SkillContract(
        name="stand",
        steps=[
            SkillStep(ExecutorKind.SAY, {"text": "[excited] 好，我站起來！"}),
            SkillStep(ExecutorKind.MOTION, {"name": "stand"}),
        ],
        priority_class=PriorityClass.SKILL,
        cooldown_s=3.0,
        description="Stand up (StandUp 1004) — pairs with sit_along.",
        bucket="active",
        display_name="站起來",
        demo_status_baseline="available_execute",
        demo_value="medium",
        demo_reason="Demo 必備配對動作（坐下 / 站起）",
    ),
