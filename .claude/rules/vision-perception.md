...
paths:
  - "vision_perception/**"
  - "docs/pawai-brain/perception/gesture/**"
  - "docs/pawai-brain/perception/pose/**"
  - "docs/modules/gesture/**"
  - "docs/modules/pose/**"
  - "docs/modules/navigation/**"
---
# vision_perception 規則
詳見 `docs/pawai-brain/perception/gesture/CLAUDE.md` + `docs/pawai-brain/perception/pose/CLAUDE.md`（模組內規則真相來源）
## 快速提醒
