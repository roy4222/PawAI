...
#
# 拓撲：
#   static TF       → base_link → laser（mount 量值 v6：x=-0.035, z=0.15, yaw=π (3.1416)；雷達 0° 朝 Go2 後方，需 180° 補正）
...
echo "[1/3] static TF base_link -> laser (x=-0.035, y=0, z=0.15, yaw=3.1416)..."
