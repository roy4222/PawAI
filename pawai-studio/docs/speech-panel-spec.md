...
> 真相來源：[../../docs/architecture/studio/specs/event-schema.md](../../docs/architecture/studio/specs/event-schema.md) §2.2 SpeechState / §1.3 SpeechIntentEvent
...
| 需求 | 看哪裡 |
|------|--------|
| SpeechState / SpeechPhase / SpeechIntentEvent 欄位 | [../../docs/architecture/studio/specs/event-schema.md](../../docs/architecture/studio/specs/event-schema.md) §2.2 + §1.3 |
