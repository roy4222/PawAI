...
> 真相來源：[../../docs/architecture/studio/specs/event-schema.md](../../docs/architecture/studio/specs/event-schema.md) §2.5 GestureState / §1.4 GestureEvent
...
| 需求 | 看哪裡 |
|------|--------|
| GestureState / GestureEvent 欄位 | [../../docs/architecture/studio/specs/event-schema.md](../../docs/architecture/studio/specs/event-schema.md) §2.5 + §1.4 |
