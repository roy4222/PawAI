...
> 真相來源：[../../docs/architecture/studio/specs/event-schema.md](../../docs/architecture/studio/specs/event-schema.md) §2.6 PoseState / §1.5 PoseEvent
...
| 需求 | 看哪裡 |
|------|--------|
| PoseState / PoseEvent 欄位 | [../../docs/architecture/studio/specs/event-schema.md](../../docs/architecture/studio/specs/event-schema.md) §2.6 + §1.5 |
