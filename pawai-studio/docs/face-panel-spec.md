...
> 真相來源：[../../docs/architecture/studio/specs/event-schema.md](../../docs/architecture/studio/specs/event-schema.md) §2.1 FaceState / §1.2 FaceIdentityEvent
...
| 需求 | 看哪裡 |
|------|--------|
| FaceState / FaceTrack / FaceIdentityEvent 欄位 | [../../docs/architecture/studio/specs/event-schema.md](../../docs/architecture/studio/specs/event-schema.md) §2.1 + §1.2 |
